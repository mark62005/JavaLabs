...
public class MyArrayListSol<E> implements List<E> {
    private static final int DEFAULT_CAPACITY = 10;
    private Object[] elementData;
    private int size;

    public MyArrayListSol() {
        elementData = new Object[DEFAULT_CAPACITY];
    }

    public MyArrayListSol(int initialCapacity) {
    ...
    public MyArrayListSol(Collection<? extends E> c) {
    ...
    public int indexOf(Object o) {
        ...
        found : {
            ...
            // if object doesn't exist in the ArrayList
            return -1;
